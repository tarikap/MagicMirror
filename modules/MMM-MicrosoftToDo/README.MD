...
MODUL CONFIG TK:
{
		    module: 'MMM-MicrosoftToDo',
		    position: 'top_left',	// This can be any of the regions. Best results in left or right regions.
		    header: 'ToDoList', // This is optional
		    config: {
		      oauth2ClientSecret: 'oqIPI.W42v7Byp55Xl.ctc51yyd~9vUj8-',
		      oauth2RefreshToken: 'M.R3_BAY.CfK*BSsGtgovjvZV0fkwpJjOfBonro0LkGL*SK8iyKZ!!c0yR!ml9tp1up94*DC6ZPzXMctNG*SJb75y8VnOXdauj7KYHYNygXs99x9ovmzajkGW0eBjXi290Eu1voyllfqlBrrgkd8Tf0q7o73I*dIOsi6GT2a5g1pnBPDt8J5P5WPcofi*NoTcwByvZg9FKndrKZHpqQGKhAJ1uFEZTG74qFbGJsCcLVeyEeLw5CATPkAClk8KsrQFm9zOpyXhy7zKinSwr0fTE3LihtoG6juh!J2siWyLpDLbc4GT22qI9bQEo616ic1HPn46qMwcvidwo735gXVhH4Em*ErbYdR9kJysCvq2rlq*mKHIgiN27LfiW!ialdJyJ3JK6KSijfjDagBWou0dUZtgZUMRCzkaejcyEh4VL!rgHaTVbr2GcNloYN*hxl3dPIgzoFDooA$$',
		      oauth2ClientId: '1cac2675-6742-4d80-b6ed-f8e38e9147e7',
		      listName: 'Tasks', // optional parameter: if not specified displays tasks from default "Tasks" list, if specified will look for a task list with the specified name (exact spelling)
		      listId: 'AQMkADAwATNiZmYAZC1iODgANS1hNGMyLTAwAi0wMAoALgAAA1Lh_i4gMGJMlZDpJ2d8iWwBAB_qpxIEaN5AgOOJ-T1mRJ8AAzJQqfYAAAA=', // deprecated parameter: use listName instead
		      showCheckbox: true, // optional parameter: default value is true and will show a checkbox before each todo list item
